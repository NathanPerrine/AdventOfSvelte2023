	...
	<div class="navbar fixed top-0 z-10 h-14 border-b-2 border-accent backdrop-blur bg-base-100/50">
		<div class="navbar-start">
			<div class="dropdown">
				...
				<button
					class="menu menu-sm border border-accent dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52"
				>
					<li>
						<a href="https://github.com/NathanPerrine/AdventOfSvelte2023" target="_blank"
							><Icon icon="jam:github" width="24" /></a
						>
					</li>
					<li>
						<a href="/">Days</a>
			...
			<a href="/" class="btn btn-ghost text-xl">Advent of Svelte 2023</a>
		</div>
			...
			<ul class="menu menu-horizontal px-1">
				...
				<li>
					<details>
						...
						<ul class="p-2 border border-accent rounded-none">
							{#each days as day}
								<li><a href={day.href}>{day.day}</a></li>
							{/each}
						</ul>
