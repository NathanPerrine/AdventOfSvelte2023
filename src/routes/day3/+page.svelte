...
<section>
	<!-- Title -->
	<Title day={3} />
	<p class="hidden sm:block px-4">
		Drag and drop tiles from either column into the other to help plan out a load, or use the "Auto
		Load &rarr;" button to generate a quick load up to the maximum capacity.
	</p>
